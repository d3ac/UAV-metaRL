...
default_config = dict(
    ...
    net_size=64, # number of units per FC layer in each network
    ...
    algo_params=dict(
        ...
        num_iterations=1000, #TODO number of data sampling / training iterates
        ...
        num_train_steps_per_itr=50, #TODO number of meta-gradient steps taken per iteration
        num_evals=2, # number of independent evals
        num_steps_per_eval=200,  # nuumber of transitions to eval on
